...
function createStyles(c: AppTheme, isDark: boolean) {
  ...
  return StyleSheet.create({
    ...
    // Matches the "To'lovni davom ettirish" button in BuyConfirmSheet, so the
    // purchase flow keeps one button size and one shadow from confirm through
    // to payment. Neutral shadow — a coloured glow looks like an artefact.
    cta: {
      marginTop: 22,
      height: 60,
      borderRadius: 18,
