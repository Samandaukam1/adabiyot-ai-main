...
const BookPage = React.forwardRef<BookPageInstance, IBookPageProps>(
    (
        ...
        // Vendored patch: migrated from Reanimated 2's `useAnimatedGestureHandler`
        // + legacy `PanGestureHandler` to the modern `Gesture.Pan()` API. The `ctx`
        // object becomes a shared value (`ctxX`); onActive → onUpdate.
        ...
        const panGesture = Gesture.Pan()
            ...
            .onUpdate((event) => {
                'worklet';
                runOnJS(onDrag)(true);
                x.value = ctxX.value + event.translationX;
